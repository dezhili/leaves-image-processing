...
def get_leave_serration(contours):
    ...
    return ser4_idx, ser4_deepest_idx, serration_numbers, serration_depths, serration_widthes, \
            curvatures_mean, curvatures_median, curvatures_std, total_curvature_mean, total_curvature_median, total_curvature_std
...
# def save_to_csv(serration_numbers, serration_depths, serration_widthes, curvatures_mean, curvatures_median, curvatures_std, name_str):
#     # 将深度宽度等结果保存到文件
#     results_list = list()
#     # 写入参数配置
#     results_list.append(['serration_idx', 'serration_depth', 'serration_width', 'curvatures_mean', 'curvatures_median', 'curvatures_std'])
#
#     serration_idx = 0
...
#             serration_idx += 1
#             results_list.append([serration_idx, serration_depth, serration_width, curvature_mean, curvature_median, curvature_std])
#     # results_list.append(['total_curvature_mean', total_curvature_mean])
#
#     # 将结果保存到文件
...
#
#
# def save_curvatures_to_csv(serration_numbers, curvatures_mean, curvatures_median, curvatures_std, total_curvature_mean, total_curvature_median, total_curvature_std, name_str):
#     # 将深度宽度等结果保存到文件
#     results_list = list()
#     # 写入参数配置
#     results_list.append(['serration_idx', 'curvature_mean', 'curvature_median', 'curvature_std'])
#
#     serration_idx = 0
#     for i in range(serration_numbers+1):
#         if serration_idx >= serration_numbers:
...
#             serration_idx += 1
#             results_list.append([serration_idx, curvature_mean, curvature_median, curvature_std])
#     results_list.append(['total_curvature_mean', total_curvature_mean, 'total_curvature_median', total_curvature_median,
#                          'total_curvature_std', total_curvature_std])
#
#     # 将结果保存到文件
#     results_file = open(name_str, 'w', newline='')
#     csv_writer = csv.writer(results_file, dialect='excel')
