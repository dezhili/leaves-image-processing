...
def get_leave_serration(contours):
    ...
    serration_circums = []
    for i in range(0, len(ser4_idx), 2):
        serration_circum = get_leave_area_circum.get_leave_circum(contours[ser4_idx[i]:ser4_idx[i + 1] + 1])
        serration_circums.append(serration_circum)
    ...
    return ser4_idx, ser4_deepest_idx, serration_numbers, serration_depths, serration_widthes, \
           serration_circums, curvatures_mean, curvatures_median, curvatures_std, total_curvature_mean, \
